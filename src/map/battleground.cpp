...
void bg_guild_build_data(void)
{
	...
	strncpy(bg_guild[0].position[0].name, "Líder: Azul", NAME_LENGTH);
	...
	strncpy(bg_guild[1].position[0].name, "Líder: Vermelho", NAME_LENGTH);
	...
	strncpy(bg_guild[2].position[0].name, "Líder: Verde", NAME_LENGTH);
