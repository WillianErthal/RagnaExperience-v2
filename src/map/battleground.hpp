...
struct s_battleground_team {
	...
	int32 guild_index; /// Fake Guild [Easycore/~R]
};
...
void bg_team_rewards(int32 bg_id, int32 nameid, int32 amount, int32 kafrapoint32s, int32 quest_id, const char *var, int32 add_value, int32 bg_arena, int32 bg_result, int32 fame);
